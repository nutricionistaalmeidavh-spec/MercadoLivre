...
test('general panel declares the approved license-center capabilities explicitly',()=>{
  for(const id of ['obra.company.create','obra.company.update-license','debora.license.manage','loja-online.license.update'])assert.equal(SUPPORTED_LICENSE_CENTER_CAPABILITIES.has(id),true,id);
});
